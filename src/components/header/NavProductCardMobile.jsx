...
const NavProductCardMobile = ({ icon, heading, soon }) => {
  return (
    <div className="cursor-pointer hover:bg-primary hover:text-white rounded-lg p-2 flex border-b-[1px] pb-2 items-center">
      <div>{icon}</div>
...
export default NavProductCardMobile;
