...
const Header = () => {
  ...
  return (
    <header className="md:px-32 px-5 py-5">
      <nav className="flex items-center justify-between">
        ...
        <div className="hidden md:flex gap-5 text-black text-opacity-50">
          ...
          <Link
            className="p-3 flex items-center gap-2 hover:text-primary active:text-primary focus:text-primary hover:bg-primary rounded-lg hover:bg-opacity-20 active:bg-opacity-20 focus:bg-opacity-20 active:bg-primary focus:bg-primary"
            href="/products"
          >
            Products {""}
            <svg
