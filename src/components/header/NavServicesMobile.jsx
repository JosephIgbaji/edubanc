...
const NavServicesMobile = ({ onclick }) => {
  return (
    <div className="hidden w-[280px] z-10 bg-white p-3 group-hover:flex flex-col gap-5">
      <Link onClick={onclick} href="#">
        <NavProductCardMobile
          ...
          heading="Tuition Collection & Remittance Services"
        />
      </Link>
      <Link onClick={onclick} href="#">
        <NavProductCardMobile
