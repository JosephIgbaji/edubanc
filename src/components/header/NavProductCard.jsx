...
const NavProductCard = ({ icon, heading, details }) => {
  return (
    <div className="max-w-[400px] hover:bg-primary hover:text-white rounded-lg p-2 flex  gap-3 border-b-[1px] pb-2 justify-between items-center">
