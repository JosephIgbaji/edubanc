    ...
    <div className="relative w-3/4 mb-32 flex items-center justify-center sm:block">
      <div className="flex flex-col gap-5 p-8 bg-green-700 rounded-2xl">
        ...
        <p className="text-xs text-gray-300">
          We want teachers to get more support. We want them to be trained like{" "}
          the <br /> professionals they are.Our goal is to train 1 million
          teachers by 2030.
        </p>
        ...
        <p className="text-xs text-gray-300">
          Every hero needs a helping hand, even our teachers. They light up the{" "}
          <br />
