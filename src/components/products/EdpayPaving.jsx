...
const EdpayPaving = () => {
  return (
    <div className="flex justify-between lg:flex-row flex-col items-center mt-28 mb-28 gap-16 ">
      <div className="min-w-[300px] lg:max-w-[500px]">
        <Image
          className="rounded-lg"
          src="/edpayleftimage.png"
          width={600}
          height={466}
          alt="logo-icon-overlay"
        />
      </div>
      <div className="min-w-[320px] lg:max-w-[500px] mb-10 md:mb-0">
        ...
        <p className="text-sm mb-5 text-textGray">
          Our platform offers affordable funds for parents, bridging the gap in
          school fees payment. Simultaneously, schools benefit from adequate
          revenue generation, ensuring seamless day-to-day operations throughout
          the entire academic session.
        </p>
        <div className="">
          <div className="mb-3">
            <PayOption
              heading="Affordable Tuition Fee Funding"
              details="Parents can access funds to ensure timely fee payments without straining their finances"
            />
            <PayOption
              heading="Steady Revenue Generation"
              details="Schools enjoy consistent cash flow, enabling smooth daily operations and activities"
            />
            <PayOption
              heading="Academic Continuity"
              details=" Students experience uninterrupted learning cycles, fostering better academic outcomes"
            />
          </div>
        </div>
      </div>
...
export default EdpayPaving;

const PayOption = ({ heading, details }) => {
  return (
